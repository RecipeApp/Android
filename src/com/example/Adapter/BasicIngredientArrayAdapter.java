...
public class BasicIngredientArrayAdapter extends ArrayAdapter<Ingredient> {
	 ...
	 private List<Ingredient> ingredientList = null;
	    ...
	    public BasicIngredientArrayAdapter( Context context, List<Ingredient> ingredientList ) {  
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {  
	      ...
	      if ( convertView == null ) {  
	        ...
	        checkBox.setOnClickListener( new View.OnClickListener() {  
	          public void onClick(View v) {  
	            ...
	            ingredient.setBasicIngredient( cb.isChecked() ); 
	      ...
	      // Display planet data  
	      checkBox.setChecked( ingredient.isBasicIngredient() );  
